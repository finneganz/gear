  ...
  <v-app>
    ...
    >
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            ...
            <v-card-text>
              この利用規約（以下，「本規約」といいます。）は，GearArchive（以下，「当方」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
            </v-card-text>
          </v-card>
        </v-col>
      </v-row>
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            <v-card-title>第1条（適用）</v-card-title>
            <ol
              class="ml-8 body-2"
      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            <v-card-title>第2条（利用登録）</v-card-title>
            <ol
              class="ml-8 body-2"
              style="color: rgba(0,0,0,.6)"
            >
      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            <v-card-title>第3条（ユーザーIDおよびパスワードの管理）</v-card-title>
            <ol
              class="ml-8 body-2"
              style="color: rgba(0,0,0,.6)"
            >
      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            <v-card-title>第4条（禁止事項）</v-card-title>
            <v-card-text>ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。</v-card-text>
            <ol
              class="ml-8 body-2"
              style="color: rgba(0,0,0,.6)"
            >
      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            <v-card-title>第5条（本サービスの提供の停止等）</v-card-title>
            <ol
              class="ml-8 body-2"
              style="color: rgba(0,0,0,.6)"
            >
      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            <v-card-title>第6条（利用制限および登録抹消）</v-card-title>
            <ol
              class="ml-8 body-2"
              style="color: rgba(0,0,0,.6)"
            >
      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            <v-card-title>第7条（退会）</v-card-title>
            <v-card-text>
      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            <v-card-title>第8条（保証の否認および免責事項）</v-card-title>
            <ol
              class="ml-8 body-2"
              style="color: rgba(0,0,0,.6)"
            >
      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            <v-card-title>第9条（サービス内容の変更等）</v-card-title>
            <v-card-text>
      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            <v-card-title>第10条（利用規約の変更）</v-card-title>
            <v-card-text>
      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            <v-card-title>第11条（個人情報の取扱い）</v-card-title>
            <v-card-text>
      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            <v-card-title>第12条（通知または連絡）</v-card-title>
            <v-card-text>
      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            <v-card-title>第13条（権利義務の譲渡の禁止）</v-card-title>
            <v-card-text>
      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-card flat>
            <v-card-title>第14条（準拠法・裁判管轄）</v-card-title>
            <ol
              class="ml-8 body-2"
              style="color: rgba(0,0,0,.6)"
            >
